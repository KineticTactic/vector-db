...
TEST(DistanceTest, Distance_with_self_is_zero) {    // if anyones reading this feel free to convert this to PascalCase- due to inexplicable circumstances i cannot type a capital w rn
